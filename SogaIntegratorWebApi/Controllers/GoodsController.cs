...
namespace SogaIntegratorWebApi.Controllers
{
    ...
    public class GoodsController : ControllerBase
    {
        ...
        /// <summary>
        /// Return goods by parametr name and value 
        /// </summary>
        /// <param name="parName"></param>
        /// <param name="parValue"></param>
        /// <returns></returns>
        [HttpGet("{parName}/{parValue}")]
        public IActionResult Get(string parName, string parValue)
        {
            ...
            {
                case "name":
                    whereCondition = "where NAZWA_TW LIKE '%" + parValue + "%'";
                    break;
                default:
                    break;
            }
        ...
        /// <summary>
        /// Return goods by id elements list separated by comma ","
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        [HttpGet("{id}")]
        ...
        /// <summary>
        /// Return list of Towar reading FbDataReader 
        /// </summary>
        /// <param name="reader"></param>
        /// <returns></returns>
        private List<Towar> GenerateGoodsList(FbDataReader reader)
        {
            List<Towar> list = new List<Towar>();
            while (reader.Read())
            {
